...
The library has been designed specifically to avoid the need for procedural macros when writing shader code.
Instead, all macro magic is contained within derive macros for user-defined types that occur in shader signatures.
This approach aims to enhance the transparency of shader code.
